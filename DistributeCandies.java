...
public class DistributeCandies {
	...
	public int distributeCandies(int[] candyType) {
		Set<Integer> uniqueCandySet = new HashSet<Integer>();
		for(Integer i : candyType) {
			uniqueCandySet.add(i);
		}
		
		return Math.min(uniqueCandySet.size(), candyType.length/2);
	}
	...
	public static void main(String []args) {
		...
		System.out.println(d.distributeCandies(new int[] {3, 3, 2, 2}));
		System.out.println(d.distributeCandies(new int[] {1, 1, 2, 4}));
